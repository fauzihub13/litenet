...
class TransactionRepositoryImpl extends TransactionRepository {
  ...
  @override
  Future<Either<Failure, TransactionResponse>> getAllTransaction() async {
    try {
      final response = await transactionDatasource.getAllTransaction();
  ...
  Future<Either<Failure, DetailTransactionResponse>> getDetailTransaction({
    ...
    try {
      final response = await transactionDatasource.getDetailTransaction(
        orderId: orderId,
      );
