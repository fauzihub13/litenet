...
void main() {
  ...
  late ClaimDeviceUsecase claimDeviceUsecase;

  setUp(() {
    mockRepository = MockDeviceRepository();

    claimDeviceUsecase = ClaimDeviceUsecase(mockRepository);
  });
  ...
  group('ClaimDeviceUsecase', () {
    test('should call claimDevice from repository', () async {
      // arrange
      when(
        () => mockRepository.claimDevice(
          name: tName,
          adress: tAddress,
      ...
      // act
      final result = await claimDeviceUsecase(
        name: tName,
        address: tAddress,
        kitSerialNumber: tKitSerialNumber,
        nodelink: tNodelink,
